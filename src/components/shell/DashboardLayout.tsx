...
export function DashboardLayout({ displayName, connectedChannels, threads, stockProducts }: DashboardLayoutProps) {
  ...
  return (
    <div className={`pt-root${rightOpen ? '' : ' no-right'}`}>
      ...
      <main className="pt-main">
        ...
        />
        <DashboardView threads={threads} stockProducts={stockProducts} />
      </main>
